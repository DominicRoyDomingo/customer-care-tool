...
namespace App\Models\PaymentPlan\Traits\Methods;

/**
 * Questionnaire Methods
 */
trait PaymentPlanMethod
{
    ...
    public function get_locale_data($json)
    {
        $object = json_decode($json, true);
        $local = locale();
        $result = array_key_exists($local, $object) ? $result = $object[$local] : "";
