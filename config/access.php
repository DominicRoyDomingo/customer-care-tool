...
return [
    ...
    'users' => [
        ...
        // The executive role all new registered users who created organization get added to
    ...
    's3_path' => [
        'users' => env('USERS_PATH', ''),
        'brands' => env('BRANDS_PATH', ''),
        'attachments' => env('ATTACHMENTS_PATH', ''),
        'email_templates' => env('EMAIL_TEMPLATES_PATH', ''),
        'campaign_emails' => env('CAMPAIGN_EMAILS_PATH', ''),
        'medical_term' => env('MEDICAL_TERM_PATH', 'medical-terms'),
        'article' => env('ARTICLE_PATH', 'articles'),
        'questions' => env('QUESTIONS_PATH', 'questions'),
        'icon' => env('ICON_PATH', 'term-icons'),
    ],

    'description_method' => env('DESCRIPTION_METHOD', 'mutual'),

    'service_id' => env('SERVICE_ID', 1)
];
