...
import { API_ORGANIZATION_CATEGORIES } from "./../../common/API.service";
...
const getters = {
  ...
  organization_categories: (state) => state.organization_categories,
...
const actions = {
  async get_organization_categories({ commit }, params) {
    console.log(params)
    try {
      const resp = await axios.get(API_ORGANIZATION_CATEGORIES, { params });
  ...
  async get_brand({ commit }, params) {
    try {
      const resp = await axios.get(API_ORGANIZATION_CATEGORIES + "/" + params.id, { params });
      commit("set_organization_categories", resp.data);
    } catch (error) {
      console.log(error);
    }
  ...
  async get_categories({ commit }, params) {
    try {
      const resp = await axios.get(API_ORGANIZATION_CATEGORIES + "/category/categories", { params });
  ...
  async get_organization_category_name({ commit }, params) {
    try {
      const resp = await axios.get(API_ORGANIZATION_CATEGORIES + `/get-organization-category-name?api_token=${params.get('api_token')}&id=${params.get('id')}&lang=${params.get('lang')}`, { params });
      return resp.data
    } catch (error) {
      console.log(error);
    }
  ...
  post_organization_category({ commit }, params) {
    return new Promise((resolve, reject) => {
      axios
        .post(API_ORGANIZATION_CATEGORIES, params)
        .then((resp) => {
          resolve(resp);
  ...
  post_category({ commit }, params) {
    return new Promise((resolve, reject) => {
      axios
        .post(API_ORGANIZATION_CATEGORIES + '/category/categories', params)
        .then((resp) => {
          resolve(resp);
          commit("set_response_status", resp.data);
        })
  ...
  delete_organization_category({ commit }, params) {
    return new Promise((resolve, reject) => {
      axios
        .delete(API_ORGANIZATION_CATEGORIES, { params })
        .then((resp) => {
          resolve(resp);
          commit("set_response_status", resp.data);
