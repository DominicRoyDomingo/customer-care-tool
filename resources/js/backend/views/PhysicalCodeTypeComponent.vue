        ...
        <v-card-title>
          <v-row>
            ...
            <v-col>
              <v-btn
                color="success"
                @click="createPhysicalCodeType()"
                class="float-right"
                tile
              >
                <v-icon dark>mdi-map-marker-plus</v-icon>
                &nbsp;
                {{ $t(modal.createPhysicalCodeType.button.new) }}
              </v-btn>
            </v-col>
          </v-row>
        </v-card-title>
...
import Create from "./includes/physical-code-type/CreateComponent.vue";

import Edit from "./includes/physical-code-type/UpdateComponent.vue";
...
export default {
  ...
  data: function() {
    ...
    return {
      ...
      translations: {
        ...
        it: {
          title: "Modifica il tipo di codice fisico",
          name: "Nome",
          button: "Aggiornare",
          cancel: "Annulla"
        },
        ...
        de: {
          title: "Physischen Codetyp bearbeiten",
          name: "Name",
        ...
        ph_fil: {
          title: "I-edit ang Uri ng Physical Code",
          name: "Pangalan",
          button: "Update",
          cancel: "Kanselahin"
        },
        ...
        ph_bis: {
          title: "Pag-edit sa Type sa Physical Code",
          name: "Ngalan",
          button: "Pagbag-o",
          cancel: "Kanselahon"
        }
      ...
      modal: {
        ...
        edit: {
          ...
          name: "physical_code_type_edit_button",
          ...
          button: {
            ...
            new: "physical_code_type_edit_button",
  ...
  methods: {
    ...mapActions("physical_code_type", ["get_physical_code_types", "delete_physical_code_type", "remove_from_physical_code_type_array"]),
    ...
    successfullySavedPhysicalCodeType(){
      this.$refs.table.refresh();
    },

    createPhysicalCodeType() {
      this.form.language = this.$i18n.locale;
      this.$bvModal.show("physical-code-type-add-modal");
    ...
    onEdit(item,index) {
      ...
      this.form.reset();
      if(name == "") {
        this.form.physical_code_type_name = item.name;
      }
      this.nameTranslation = name;
      this.form.language = this.$i18n.locale;
      this.form.id = item.id;
      this.$bvModal.show("physical-code-type-edit-modal");
    },
      ...
      $.confirm({
        title:
          ...
          vm
            ...
            .slice(1)
            .toUpperCase(),
        content: vm.$t( "question_record_delete") + `${item.name}` + vm.$t( "from") +  vm.$t( "label.physical_code_type") + vm.$t( "records")+"?",
        type: "red",
        typeAnimated: true,
        columnClass: "medium",
        buttons: {
          yes: {
            ...
            action: function(value) {
              if (value) {
                ...
                vm.delete_physical_code_type(params)
                  .then((resp) => {
                    ...
                    if (vm.physicalCodeTypesResponseStatus) {
                      vm.loadItems()
                      vm.makeToast(
                        "danger",
                        vm.$t("delete_record"),
