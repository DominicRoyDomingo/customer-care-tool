          ...
          <v-row>
            ...
            <v-col>
              ...
              >
                ...
                &nbsp;
                {{ $t(modal.createProviderGroup.button.new) }}
              </v-btn>
            </v-col>
          </v-row>
        </v-card-title>
              ...
              >
                ...
                <template v-slot:cell(name)="data">
                  <div style="margin: 10px 0 0 25px;">
                    ...
                    <a href="#" class="font-weight-bold" @click.prevent="showProvidersList(data.item)">
                      {{ data.item.name }}
                    </a>
                  </div>
                </template>
...
import Create from "./includes/provider-group/CreateComponent.vue";
import Edit from "./includes/provider-group/UpdateComponent.vue";
...
export default {
  ...
  data: function() {
    return {
      ...
      modal: {
        ...
        edit: {
          name: "provider_group_add_edit_button",

          id: "provider-group-edit-modal",
      ...
      translations: {
        ...
        it: {
          title: "Modifica gruppo di fornitori",
          name: "Nome",
        ...
        de: {
          title: "Anbietergruppe bearbeiten",
          name: "Name",
        ...
        ph_fil: {
          title: "I-edit ang Pangkat ng Provider",
          name: "Pangalan",
        ...
        ph_bis: {
          title: "Pag-edit sa Pangkat sa Tagahatag",
          name: "Ngalan",
  ...
  methods: {
    ...mapActions("provider_group", [
        "get_provider_groups",
        "delete_provider_group",
        "remove_from_provider_group_array"
    ]),
    ...
    async loadItems() {
      ...
      this.get_provider_groups(params).then((_) => {
        this.tableTotalRows = this.items.total
        this.isLoading = false;
      });
    },

    successfullySavedProviderGroup() {
      this.$refs.providerGroupTable.refresh();
    },

    createProviderGroup() {
      this.form.reset();
      this.modalId = this.modal.createProviderGroup.id;
    ...
    onEdit(item, index) {
        ...
        this.form.provider_group_name = item.name;
        ...
        let parameters = {
            ...
            buttons: {
                ...
                action: function(value) {
                    ...
                    vm.delete_provider_group(params)
                        .then((resp) => {
                        ...
                        if (vm.providerGroupsResponseStatus) {
                            vm.loadItems();
                            vm.makeToast(
                            "danger",
                            vm.$t("delete_record"),
  ...
  computed: {
    ...mapGetters("provider_group", {
      ...
      providerGroupsResponseStatus: "get_response_status",
    }),
