...
import Edit from "../../includes/geolocalization/regions/UpdateComponent.vue";
...
export default {
  ...
  methods: {
    ...mapActions("geolocalization", ["get_geolocalization_regions", "delete_geolocalization", "remove_from_geolocalization_array"]),
    ...mapActions("geolocalization_template", ["get_geolocalization_template"]),
    ...mapActions("country", ["get_all_region"]),
    ...
    async loadItems() {
      ...
      this.get_geolocalization_regions(params).then(_ => {
    ...
    onEdit(item,index) {
      ...
      this.place = item
      this.loadPlaces();
      this.$bvModal.show("geolocalization-region-edit-modal");
    },
