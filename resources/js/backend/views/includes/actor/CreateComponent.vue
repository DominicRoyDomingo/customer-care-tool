                            ...
                            >
                              ...
                              <div class="form-group">
                                ...
                                <v-select
                                  ...
                                  id="information_type"
                                  @input="parent.form.other_infos[index].value = ''"
                                >
                                  <template #list-header>
                                    <li style="margin-left: 20px" class="mb-2">
                                      <b-link
...
export default {
  ...
  watch: {
    filter(value) {
      if (!value) {
        this.parent.tableTermLoading = true;
  ...
  methods: {
    ...
    openPhysicalCodeTypeModal() {
      ...
      this.parent.$bvModal.hide(this.parent.modalId);
      this.parent.modalId = this.parent.modal.add.id
      ...
      this.post_actor(params)
        .then((resp) => {
          ...
          if (this.parent.actorsResponseStatus) {
            ...
            this.parent.actors.length != undefined ? this.parent.loadActors() : this.add_actor(this.parent.actorsResponseStatus);
            ...
            this.$emit("done-success"); // for article event please dont delete.
          }
        })
        .catch((error) => {
          this.modal.button.loading = false;
    ...
    onFiltered(items) {
      this.parent.termsTotalRow = items.length;
      this.parent.termsCurrentPage = 1;
    },
