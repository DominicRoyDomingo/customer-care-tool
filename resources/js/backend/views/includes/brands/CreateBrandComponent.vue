  ...
  <span class="create">
    ...
    >
      ...
      <div style="position: absolute; top: 5px; right: 10px">
        <v-btn icon color="pink" @click="modalClose">
      ...
      <v-row class="px-3">
        <v-col cols="6" md="4">
          <v-card class="mx-auto my-12" max-width="200">
            <v-img v-if="url != null" height="156" :src="url"></v-img>
            ...
            >
              ...
              <span class="white--text" style="font-size: 0.8rem !important">
                {{
                  url != null ? "Change Brand Logo" : "Upload Brand Logo"
                }}</span
              >
              <input
                id="fileUpload"
        ...
        <v-col cols="12" sm="6" md="8" class="d-flex flex-column px-5 pt-4">
          <div style="color: #4f4f4f" class="mb-4 h5">{{ $t(modal.name) }}</div>
          <b-form-group>
            <el-input
...
export default {
  ...
  data: function () {
    return {
      modal: this.parent.modal.createBrand,
  ...
  methods: {
    ...
    onSubmit() {
      ...
      // formData.append("name", this.parent.form.brand_name);
      ...
      this.post_brand(params)
        .then((resp) => {
          ...
          if (this.responseStatus) {
            ...
            let message = {
              create:
                `${this.parent.form.brand_name}` + this.$t("created_message"),
              update:
