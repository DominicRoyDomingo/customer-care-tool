<template>
  <span class="create">
    ...
    >
    <!-- modal.name -->
      <div style="position: absolute; top: 5px; right: 10px; z-index: 10000000">
        <v-btn
          icon
          color="pink"
          @click="modalClose"
        ...
        >
          ...
          <b-form-group>
              <el-select id="categories" v-model="form.brandCategories" multiple :placeholder="$t('label.select_categories')">
                <el-option
                  v-for="category in $this.newSpecializationCategories"
                  :key="category.id"
...
export default {
  ...
  data: function() {
    ...
    return {
      ...
      modal: this.$this.modal.createBrand,
  ...
  methods: {
    ...
    onSubmit() {
      ...
      formData.append("action", this.$this.form.action);
      formData.append("name", this.$this.form.brand_name);
      formData.append("website", this.$this.form.website);
      formData.append("isDefault", this.$this.form.isDefault);
      formData.append("org_id", this.$org_id);
      formData.append("file", this.file);
      formData.append("categories", JSON.stringify(this.$this.form.brandCategories))
      let params = {
          api_token: this.$user.api_token,
          locale: this.$i18n.locale,
          action: this.$this.form.action,
          name: this.$this.form.brand_name,
          website: this.$this.form.website,
          isDefault: this.$this.form.isDefault,
          org_id: this.$org_id,
          file: this.file,
          categories: this.$this.form.brandCategories,
      };
        ...
        .then((resp) => {
          ...
          $("#name,#categories").removeAttr("style");
            if (this.responseStatus) {
                ...
                let message = {
                create: `${this.$this.form.brand_name}` + this.$t("created_message") + this.$t("label.brand"),
                update:
                ...
                this.$this.form.language = this.$i18n.locale;
