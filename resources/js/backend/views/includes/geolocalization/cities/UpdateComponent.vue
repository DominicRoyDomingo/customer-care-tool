<template>
  <div class="create">
    <b-modal
      id="geolocalization-city-edit-modal"
      hide-footer
      hide-header
      size="lg"
...
export default {
  ...
  methods: {
    ...
    modalClose(done) {
      ...
      this.parent.$bvModal.hide("geolocalization-city-edit-modal");
    ...
    async infiniteScroll ([{isIntersecting, target}]) {
      if (isIntersecting) {
        setTimeout(() => {
          ...
          this.parent.get_all_city(params).then((data) => {
    ...
    onSubmit() {
      ...
      this.post_geolocalization(formData)
        .then((resp) => {
          ...
          this.$bvModal.hide("geolocalization-city-edit-modal");
