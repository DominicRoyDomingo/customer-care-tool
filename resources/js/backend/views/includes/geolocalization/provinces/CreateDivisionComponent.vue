<template>
  <div>
    <b-modal
      id="geolocalization-province-province-modal"
      @hide="hide"
      hide-header
      hide-footer
      size="lg"
        ...
        <v-card>
          <v-card-title class="title blue-grey lighten-4 text--secondary">
            ...
            <v-btn
              ...
              @click="$bvModal.hide('geolocalization-province-province-modal')"
            >
...
export default {
  ...
  methods: {
    ...mapActions("location", ["add_province", "update_province", "filter_provinces"]),
    ...
    onSave() {
      ...
      this.saving = true;
        this.add_province(params)
          .then((resp) => {
            this.saving = false;
            this.$bvModal.hide("geolocalization-province-province-modal");
            if (this.response_status) {
              ...
              vm.parent.provincePlacePage = 1;
              vm.parent.loadProvincePlaces()
            }
          })
          .catch((error) => {
            this.saving = false;
