<template>
  <div class="create">
    <b-modal
      id="geolocalization-province-edit-modal"
      hide-footer
      hide-header
      size="lg"
...
export default {
  ...
  methods: {
    ...
    modalClose(done) {
      ...
      this.parent.$bvModal.hide("geolocalization-province-edit-modal");
    ...
    async infiniteScroll ([{isIntersecting, target}]) {
      if (isIntersecting) {
        setTimeout(() => {
          ...
          this.parent.get_all_province(params).then((data) => {
    ...
    onSubmit() {
      ...
      this.post_geolocalization(formData)
        .then((resp) => {
          ...
          this.$bvModal.hide("geolocalization-province-edit-modal");
