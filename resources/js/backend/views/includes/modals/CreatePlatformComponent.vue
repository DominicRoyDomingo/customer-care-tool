<template>
  ...
  <div class="create">
          ...
          <b-form-group>
            ...
            <!-- <select v-model="form.platform_type" class="form-control text-capitalize" >
              ...
              <option
                ...
                :key="index"
              >{{type.name}} <small v-if="type.convertion==true" style="color:red">(No {{ type.language }} translation yet)</small></option>
              ...
              <template #list-header>
                <li style="margin-left:20px;" class="mb-2">
                  <b-link href="#" @click="openPlatformTypeModal">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                    {{$t('platform_type_add_new_button')}}
                  </b-link>
                </li> 
              </template>
            </v-select>
    ...
    <PlatformType :this_cpc="this" :parent="$this"></PlatformType>

    <Brand :this_cbc="this" :parent="$this"></Brand>
...
import PlatformType from "./../modals/CreatePlatformTypeComponent.vue";
...
export default {
  ...
  methods: {
    openPlatformTypeModal(){
        ...
        this.$this.$bvModal.show("create-platform-type");
    ...
    openBrandModal(){
        ...
        this.$this.$bvModal.show("brand-modal");
    ...
    onSubmit() {
      ...
      const data = {
        ...
        platform_type: this.form.platform_type.id,
      ...
      createPlatform(formData).then(resp => {
        ...
        //   });
          ...
          getLastStatus().then(resp => {
            ...
            this.$this.users = resp.users;

            this.$this.platforms = resp.platforms;
          ...
          if( this.keep_open == true ) {
            ...
            this.$this.$bvModal.hide("create-platform");
