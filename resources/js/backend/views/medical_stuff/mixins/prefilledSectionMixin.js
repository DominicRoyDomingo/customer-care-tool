...
export default {
   ...
   watch: {
      language(value) {
         switch (value) {
            case 'en':
               this.prefilledsection_form.section_name = this.prefilledsection_modal.form.is_english;
               // this.termConform.note = this.itemSelected.is_english;
               break;
            case 'it':
               this.prefilledsection_form.section_name = this.prefilledsection_modal.form.is_italian;
               break;
            case 'de':
               this.prefilledsection_form.section_name = this.prefilledsection_modal.form.is_german;
               break;
            case 'ph-bis':
               this.prefilledsection_form.section_name = this.prefilledsection_modal.form.is_bisaya;
               break;
            case 'ph-fil':
               this.prefilledsection_form.section_name = this.prefilledsection_modal.form.is_filipino;
               break;
         }
      },
