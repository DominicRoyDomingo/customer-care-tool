...
export default {
   ...
   watch: {
      language(value) {
         this.form.description = this.plan.data.base_description[value] ?? "";
         this.form.features = this.plan.data.base_features[value] ?? "";
         switch (value) {
            case 'en':
               this.form.name = this.plan.data.is_english;
               break;
            case 'it':
               this.form.name = this.plan.data.is_italian;
               break;
            case 'de':
               this.form.name = this.plan.data.is_german;
               break;
            case 'ph-bis':
               this.form.name = this.plan.data.is_bisaya;
               break;
            case 'ph-fil':
               this.form.name = this.plan.data.is_filipino;
               break;
         }
      },
