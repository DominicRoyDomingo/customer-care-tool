  ...
  methods: {
            ...
            action: function(value) {
              if (value) {
                let params = {
                  ...
                  note: vm.parent.form.notes[vm.parent.editingIndex],
                };
                ...
                vm.post_to_action_route(params)
                  .then((resp) => {
                    ...
                    if (resp.responseStatus) {
                      ...
                      vm.parent.deletedNoteSuccessfully(resp.notes);
    ...
    onSave() {
      ...
      let params = {
        ...
        note: this.parent.form.notes[this.parent.editingIndex]
      };
      ...
      this.post_to_action_route(params)
        .then((resp) => {
          ...
          if (resp.responseStatus) {
            ...
            //Add callback function here if necessary
            this.parent.updatedNoteSuccessfully(resp.notes);
          }
        })
        .catch((error) => {
          console.log(error);
