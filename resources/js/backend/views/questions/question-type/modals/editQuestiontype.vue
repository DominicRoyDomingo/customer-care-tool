...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      vm.$store.dispatch('question_types/updateQuestionType', {formData : formData, id: vm.form.id}).then((response) => {
          ...
          if (response.data.success === true) {
              ...
              vm.form.reset()
              vm.$store.dispatch('question_types/getQuestionTypes', { api_token : vm.$user.api_token, locale : vm.$i18n.locale });
          }
