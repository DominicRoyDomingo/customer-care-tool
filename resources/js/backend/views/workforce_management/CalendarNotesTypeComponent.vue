          ...
          <v-row>
            <v-container fluid>
              <b-table
                ...
                v-model="calendarNotesTypeTable"
              >
                ...
                <template v-slot:cell(color_hexcode)="data">
                  <div style="margin-top: 10px">
                    <span
                      class="text-left text--secondary"
                    >
                      {{ data.item.color_hexcode }}
          ...
          <v-row>
            <v-spacer>
              <v-col cols="12" sm="6" md="4">
                <span>
                  Showing
                  <strong v-text="calendarNotesTypeTable.length" />
                  of
...
import Create from "./Calendar-notes-type/CalendarNotesTypeCreateComponent.vue";

import Edit from "./Calendar-notes-type/CalendarNotesTypeUpdateComponent.vue";
...
export default {
  ...
  data: function() {
    return {
      ...
      modal: {
        add: {
          name: "calendar_notes_type_type_add_new_button",
          ...
          button: {
            ...
            new: "calendar_notes_type_add_new_button",
        ...
        edit: {
          name: "calendar_notes_type_edit_button",
        ...
        createCalendarNotesType: {
          name: "calendar_notes_type_add_new_button",
  ...
  methods: {
    ...mapActions("calendar_notes_type", [
      ...
      "delete_calendar_notes_type",
      "remove_from_calendar_notes_type_array",
    ]),
    ...
    createCalendarNotesType() {
      ...
      this.$bvModal.show("calendar-notes-type-add-modal");
    },
    ...
    //   this.link_option = 'post_link_brand_calendar_notes_type';
          ...
          yes: {
            ...
            action: function(value) {
              if (value) {
                ...
                vm.delete_calendar_notes_type(params)
                  .then((resp) => {
