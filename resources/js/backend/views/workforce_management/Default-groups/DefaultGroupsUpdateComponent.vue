...
export default {
  ...
  data: function() {
    ...
    return {
      ...
      modalId: "default-groups-edit-modal",
  ...
  methods: {
    ...
    modalClose(done) {
      ...
      this.$this.$bvModal.hide("default-groups-edit-modal");
    ...
    onSubmit() {
      ...
      this.post_default_groups(formData)
        .then((resp) => {
          ...
          this.$bvModal.hide("default-groups-edit-modal");
    ...
    selectLang(event) {
      ...
      this.form.language = event.target.value;
      this.get_default_groups_name(formData).then((resp) => {
        if (resp) {
          this.form.name = resp;
        } else {
          this.form.name = "";
