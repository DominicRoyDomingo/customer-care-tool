          ...
          <v-row>
            <v-col>
              <span class="title font-weight-light text--secondary">
                {{ this.brand_session.name }}  {{ $t("default_groups_list") }}
              </span>
            </v-col>
            <v-spacer> </v-spacer>
            <v-col>
          ...
          <v-row>
            <v-spacer>
              <v-col cols="12" sm="6" md="4">
                <span>
                  Showing
                  <strong v-text="defaultGroupTable.length" />
                  of
...
import Create from "./Default-groups/DefaultGroupsCreateComponent.vue";

import Edit from "./Default-groups/DefaultGroupsUpdateComponent.vue";
...
export default {
  ...
  data: function() {
    return {
      ...
      modal: {
        add: {
          name: "default_groups_add_new_button",
          ...
          button: {
            ...
            new: "default_groups_add_new_button",
        ...
        edit: {
          name: "default_groups_edit_button",

          id: "default-groups-edit-modal",
  ...
  methods: {
    ...mapActions("default_groups", [
      "get_default_groups",
      "delete_default_groups",
      "remove_from_default_groups_array",
    ]),
    ...
    async loadItems() {
      ...
      this.get_default_groups(params).then((_) => {
    ...
    successfullySavedDefaultGroups() {
    ...
    createDeafultGroups() {
      ...
      // this.get_default_groups(params).then((_) => {
        this.$bvModal.show("default-groups-add-modal");
      // });
    },

    openDefaultGroupBrandModal() {
      // this.brands.reset();
    ...
    onLinkBrand(item, index) {
      ...
      this.link_option = 'post_link_brand_default_groups';
          ...
          yes: {
            ...
            action: function(value) {
              if (value) {
                ...
                vm.delete_default_groups(params)
                  .then((resp) => {
                    ...
                    if (vm.defaultGroupsResponseStatus) {
                      vm.loadItems();
                      vm.makeToast(
                        "danger",
                        vm.$t("delete_record"),
  ...
  computed: {
    ...mapGetters("default_groups", {
      items: "default_groups",
      // categories: "categories",
      defaultGroupsResponseStatus: "get_response_status",
    }),
