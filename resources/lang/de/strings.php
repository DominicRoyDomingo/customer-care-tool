    ...
    */
    ...
    'backend' => [
        ...
        'contact_types' => [
            'title' => 'Kontakttypen',
            'welcome' => 'Herzlich willkommen',
            'added' => ' wurde als neuer Kontakttyp erstellt',
            'updated' => 'Die Informationen für die Kontakttyp-ID: ',
            'updated2' => ' wurde aktualisiert.',
            'deleted' => ' wurde aus den Kontakttypdatensätzen entfernt.',
        ],

        'brands' => [
            'title' => 'Marken',
            'welcome' => 'Herzlich willkommen',
            'added' => ' wurde als neue Marke erstellt',
            'updated' => 'Die Informationen für Brand ID: ',
            'updated2' => ' wurde aktualisiert.',
            'deleted' => ' wurde aus den Markendatensätzen entfernt.',
        ],
        ...
        'profiles' => [
            'title' => 'Kundenprofile',
            'welcome' => 'Herzlich willkomme',
            'view' => 'Client-Profil anzeigen',
            'added' => ' wurde als neues Kundenprofil erstellt',
            'updated' => 'Die Informationen für die Client-Profil-ID:',
            'updated2' => ' wurde aktualisiert.',
            'deleted' => ' wurde aus den Clientprofildatensätzen entfernt.',
            'added_note' => 'Neue Notiz wurde hinzugefügt ',
            'added_contact' => 'Neuer Kontakt wurde hinzugefügt ',

            'brands_updated' => 'Die Markeninformationen für die Kundenprofil-ID: ',
            'brands_updated2' => ' wurde aktualisiert.',
        ],
