...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'contact_types' => [
            'title' => 'Tipi di contatto',
            'welcome' => 'Benvenuto',
            'added' => ' è stato creato come nuovo tipo di contatto',
            'updated' => 'Le informazioni per l\'ID del tipo di contatto: ',
            'updated2' => ' è stato aggiornato.',
            'deleted' => ' è stato rimosso dai record del tipo di contatto.',
        ],

        'brands' => [
            'title' => 'Marche',
            'welcome' => 'Benvenuto',
            'added' => ' è stato creato come un nuovo marchio',
            'updated' => 'Le informazioni per l\'ID marchio: ',
            'updated2' => ' è stato aggiornato.',
            'deleted' => ' è stato rimosso dai record del marchio.',
        ],
        ...
        'provider_type' => [
            'title' => 'Tipo di provider',
            'welcome' => 'Welcome',
        ],

        'provider_services' => [
            'title' => 'Servizi del fornitore',
            'welcome' => 'Welcome',
        ],
        ...
        'attachments' => [
            'main' => 'Allegati',
            'category' => 'Categoria di Documento',
        ...
        'profiles' => [
            'title' => 'Profili del cliente',
            'welcome' => 'Benvenuto',
            'view' => 'Visualizza il profilo del cliente',
            'added' => ' è stato creato come nuovo profilo cliente',
            'updated' => 'Le informazioni per l\'ID profilo cliente: ',
            'updated2' => ' è stato aggiornato.',
            'deleted' => ' è stato rimosso dai record del profilo client.',
            'added_note' => 'Nuova nota è stata aggiunta a ',
            'added_contact' => 'Nuovo contatto è stato aggiunto a ',

            'brands_updated' => 'Le informazioni sul marchio per l\'ID profilo cliente: ',
            'brands_updated2' => ' è stato aggiornato.',
        ],
