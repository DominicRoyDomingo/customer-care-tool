...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::get('user/invite', [UserStatusController::class, 'inviteUsers'])->name('user.invite');
        Route::get('user/switchorg/{organization}', [UserController::class, 'switchOrg'])->name('user.switchorg');
        Route::get('user/invite/{organization}/{token}/{organization_exec_code}/{notif_id}', [UserController::class, 'inviteConfirm'])->name('user.invite.confirm');
        Route::post('user/invite', [UserController::class, 'inviteUser'])->name('user.invite.send');
        Route::post('user/notif/read', [UserController::class, 'readNotif'])->name('user.notif.read');
        Route::get('user/notif', [UserController::class, 'userNotifs'])->name('user.notif');
        Route::delete('user/notif/{notif}', [UserController::class, 'declineNotif'])->name('user.decline');
        ...
        Route::group(['prefix' => 'user/invite/{user}'], function () {
            // User
            // Route::patch('/', [UserController::class, 'inviteUser'])->name('user.invite.send');
